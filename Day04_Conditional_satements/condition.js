...
//    }
  ...
  if(a>b){
    console.log(`the largest number between ${a} and ${b} are := ${a}`)
  }
  else if(a<b){
    console.log(`the largest number between ${a} and ${b} are := ${b}`)
  }
  else{
    console.log(`the largest number between ${a} and ${b} are equal`)
  }
